          ...
          <div class="relative">
            ...
            >
              <div v-if="showUserDropdown" class="absolute right-0 top-full mt-2 w-44 bg-bg-card border border-border shadow-lg py-1 z-50">
                ...
                <a href="https://discord.gg/7ZRHz76gP2" target="_blank" rel="noopener" class="w-full text-left px-4 py-2 text-sm text-text-tertiary hover:text-text-primary hover:bg-bg-elevated transition-colors flex items-center gap-2">
